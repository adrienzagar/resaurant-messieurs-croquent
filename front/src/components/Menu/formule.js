...
const Formule = () => {
    ...
    return (
        <div className="formule">
            <div className="formule__card" data-aos="fade-up">
                <div className="formule__header">
                    ...
                    <svg version="1.1" id="croc-reverse-min" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 204 117.5">
            ...
            <div className="formule__card" data-aos="fade-up">
                <div className="formule__header--left">
                    À tout moment
                    <svg version="1.1" id="croc-reverse" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 204 117.5">
                        <rect x="0.2" y="0.1" class="st0" width="203.7" height="117.2"/>
                        <ellipse transform="matrix(0.1347 -0.9909 0.9909 0.1347 70.9974 247.2497)" class="st1" cx="177.1" cy="83" rx="22.3" ry="27"/>
                        <ellipse class="st1" cx="136.4" cy="82.3" rx="18.6" ry="15.1"/>
                        <ellipse class="st1" cx="108.8" cy="57.3" rx="33.5" ry="29.4"/>
