 ...
 */
final class Version20200730123635 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE order_line CHANGE id_order_id order_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE order_line CHANGE order_id id_order_id INT DEFAULT NULL');
